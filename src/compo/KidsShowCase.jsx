...
const Images = [
  { src : Mike, alt: "Mike" },
  { src : Chris, alt: "Chris" },
  { src : Dataanalytics, alt: "Data Analytics" },
  { src : Webdev, alt: "Web Development" },
  { src : Classsection, alt: "Class Section" },
  { src : Newstudent, alt: "New Student" },
  
    

]

function KidsPicture({divclassName="carousel-item",imgclassName="h-75 w-140 object-cover rounded-lg"}) {
  return (
    <div>
      <div className="carousel carousel-center rounded-box space-x-4 p-2">
        {Images.map((img, i) => (
          <div key={img.src + i} className={divclassName}>
            <img
              src={img.src}
...
//         <div className="carousel-item">
//           <img
//             src="https://images.unsplash.com/photo-1542281286-9e0a16bb7366?auto=format&fit=crop&w=1200&q=60"
//             alt="Pizza"
//             loading="lazy"
//             className="h-48 w-72 object-cover rounded-lg"
//           />
...
//         <div className="carousel-item">
//           <img
//             src="https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=1200&q=60"
//             alt="Pizza"
//             loading="lazy"
//             className="h-48 w-72 object-cover rounded-lg"
//           />
...
//         <div className="carousel-item">
//           <img
//             src="https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=1200&q=60"
//             alt="Pizza"
//             loading="lazy"
//             className="h-48 w-72 object-cover rounded-lg"
//           />
