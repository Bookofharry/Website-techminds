...
export default function NavBar() {
  const items = [
    { label: "Home", icon: "pi pi-home", template: linkTemplate("/") },
    { label: "Facilities", icon: "pi pi-star", template: linkTemplate("/facilities") },
    {
      label: "Programs",
      icon: "pi pi-search",
      items: [
        ...
        { label: "Digital Marketing", icon: "pi pi-pencil", template: linkTemplate("/programs/digital-marketing") },
        {
          ...
          icon: "pi pi-palette",
          items: [
            { label: "Web Development", icon: "pi pi-palette", template: linkTemplate("/programs/software-engineering/web-development") },
            { label: "App Development", icon: "pi pi-palette", template: linkTemplate("/programs/software-engineering/app-development") },
          ],
        },
      ],
    },
