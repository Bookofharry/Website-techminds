...
function Kids() {
  return (
    <section className="relative overflow-hidden bg-white">
      {/* subtle brand blur bar (same style as App Dev) */}
      <div
        aria-hidden
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="mt-16 lg:mt-24">
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { t: "Scratch Games", d: "Arcade-style games while learning loops, events & sprites." },
              { t: "Roblox Worlds", d: "Create obstacle courses and simple scripts with Lua." },
              { t: "Web Pages", d: "Colorful, kid-safe pages with HTML & CSS basics." },
              { t: "Python Turtle", d: "Draw shapes & patterns—gentle intro to code & logic." },
            ].map((c, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-2 text-xs">
                  <span className="rounded-full bg-gray-100 px-2 py-1 text-gray-700">Beginner-friendly</span>
                  <span className="rounded-full bg-gray-100 px-2 py-1 text-gray-700">Safe & guided</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            to="/application"
            className="inline-flex items-center justify-center rounded-2xl bg-gray-900 px-5 py-3 text-sm font-semibold text-white shadow transition hover:-translate-y-0.5 hover:bg-gray-800 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900/30"
          >
