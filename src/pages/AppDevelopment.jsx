      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 pt-12 pb-8 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-gray-600">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-800 via-blue-200 to-blue-800">first screen</span>{" "}
            to{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-800 via-blue-200 to-blue-800">store-ready build</span>
            .
          </p>
